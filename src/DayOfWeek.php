<?php
    class DayOfWeek
    {
        public $monthCodeArray = array("1"=>0, "2"=>3, "3"=>3, "4"=>6, "5"=>1, "6"=>4, "7"=>6, "8"=>2, "9"=>5, "10"=>0, "11"=>3, "12"=>5);
        public $centuryCodeArray = array("17"=>4, "18"=>2, "19"=>0, "20"=>6, "21"=>4, "22"=>2, "23"=>0);
        public $dayCodeArray = array("0"=>"Sunday", "1"=>"Monday", "2"=>"Tuesday", "3"=>"Wednesday", "4"=>"Thursday", "5"=>"Friday", "6"=>"Saturday");
